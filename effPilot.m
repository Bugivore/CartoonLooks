...
-(id)init:(clsDataFace*)inFaceData:(Boolean)bIsMale
{
    ...
    fLeftMargin = 102/590.0;
    fRightMargin = 122/590.0;
    fTopMargin = 333/590.0;
    fBottomMargin = 0;
    ...
    {
        clsDataElement * element = [clsDataElement alloc];
        element.imgElement = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"wingL" ofType:@"png"]];
        element.imgElementOrig = element.imgElement;
        element.bIsSketch = FALSE;
        element.bVisible = TRUE;
        element.rctFrame = CGRectMake(inFaceData.pntLeftEyeStart.x+super.iStartX,super.iNewH-super.iStartY-inFaceData.pntLeftEyeStart.y-inFaceData.iEyeHgt*0.5-inFaceData.iEyeHgt,inFaceData.iEyeWdt*0.75,inFaceData.iEyeWdt*((float)element.imgElement.size.width/element.imgElement.size.height)*0.75);
    ...
    {
        clsDataElement * element = [clsDataElement alloc];
        element.imgElement = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"wingR" ofType:@"png"]];
        element.imgElementOrig = element.imgElement;
        element.bIsSketch = FALSE;
        element.bVisible = TRUE;
        element.rctFrame = CGRectMake(inFaceData.pntRightEyeStart.x+super.iStartX+inFaceData.iEyeWdt*0.25,super.iNewH-super.iStartY-inFaceData.pntRightEyeStart.y-inFaceData.iEyeHgt*0.5-inFaceData.iEyeHgt,inFaceData.iEyeWdt*0.75,inFaceData.iEyeWdt*((float)element.imgElement.size.width/element.imgElement.size.height)*0.75);
        //element.bDraggable = TRUE;
        element.pntDrag = CGPointMake(0, 0);
        element.fAngleRotation = 0.0;
        element.fScaleFactor = 1.0;
    ...
    {
        clsDataElement * element = [clsDataElement alloc];
        element.imgElement = [UIImage imageWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"Pilot" ofType:@"png"]];
        element.imgElementOrig = element.imgElement;
        element.bIsSketch = FALSE;
        element.bVisible = TRUE;
        //element.bDraggable = TRUE;
